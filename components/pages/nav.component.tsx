                            ...
                            <div className="flex">
                                {routes.map((route, index) => {
                                    ...
                                    return (
                                        <a
                                            href={route.url}
                                            className={`rounded-md py-2 px-3 text-sm leading-5 font-medium text-white hover:bg-red-700 focus:bg-red-700 focus:outline-none transition duration-150 ease-in-out ${
                                                index === 0 ? '' : 'ml-4'
                                            } ${isActive ? 'bg-red-900' : ''}`}
                                        >
                                            {route.label}
                ...
                <div className="px-2 pt-2 pb-3">
                    {routes.map((route, index) => {
                        ...
                        return (
                            <a
                                href={route.url}
                                className={`block rounded-md py-2 px-3 text-base font-medium text-white focus:outline-none ${
                                    index === 0 ? '' : 'mt-1'
                                } ${isActive ? 'bg-red-900' : 'mt-1 hover:bg-red-700'}`}
                            >
                                {route.label}
                            </a>
                        );
                ...
                <div className="pt-4 pb-3 border-t border-red-400 border-opacity-25">
                    <div className="px-5 flex items-center">
                        ...
                        <div className="ml-3">
                            ...
                            <div className="text-sm font-medium leading-5 text-red-300">tom@example.com</div>
                        </div>
                    </div>
